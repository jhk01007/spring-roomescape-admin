...
public class ConsoleOutputView {
    ...
    public static void printTimeList(ReservationTimeListResponse reservationTimes) {
    ...
    public static void printReservationList(ReservationListResponse reservations) {
